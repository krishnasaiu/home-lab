...
| :--- | :--- | :--- | :--- |
| **Homepage** | `http://<server_ip>:3000/` | `https://dashboard.homelab/` | Unified Status Dashboard |
| **Pi-hole Admin** | `http://<server_ip>/admin/` | `https://pihole.homelab/admin/` | Ad-blocking & Local DNS Server |
| **Home Assistant**| `http://<server_ip>:8123/` | `https://homeassistant.homelab/` | Smart Home Hub |
| **Vaultwarden** | `http://<server_ip>:8080/` | `https://vaultwarden.homelab/` | Password Manager (Bitwarden) |
| **Paperless-ngx** | `http://<server_ip>:8000/` | `https://paperless.homelab/` | Document Archiver & OCR |
| **Uptime Kuma** | `http://<server_ip>:3001/` | `https://status.homelab/` | Service Availability Monitors |
| **pgweb Client** | `http://<server_ip>:8085/` | `https://pgweb.homelab/` | Web PostgreSQL Console |
| **Redis Commander**| `http://<server_ip>:8086/` | `https://redis-commander.homelab/` | Web Redis Console |
| **Beszel Hub** | `http://<server_ip>:8090/` | `https://beszel.homelab/` | Lightweight Server Resource Monitor |
| **Cockpit Console**| `https://<server_ip>:9090/` | N/A | Linux OS Dashboard |
| **Dozzle Logs**   | N/A                        | `https://logs.homelab/`            | Real-time Container Log Viewer      |
